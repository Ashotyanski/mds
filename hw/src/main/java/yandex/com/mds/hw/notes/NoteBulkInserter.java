...
class NoteBulkInserter {
    private static final String TAG = NoteBulkInserter.class.getName();
    ...
    private static NoteBulkInserter instance;

    public static NoteBulkInserter getInstance(Context context) {
        if (instance == null)
            instance = new NoteBulkInserter(context);
        return instance;
    }

    private NoteBulkInserter(Context context) {
        this.context = context;
        databaseHelper = NoteDatabaseHelper.getInstance(context);
