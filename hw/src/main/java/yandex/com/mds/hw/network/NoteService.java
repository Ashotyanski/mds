...
public interface NoteService {
    ...
    Call<NoteServiceResponse<List<ColorRecord>>> getNotes(@Path("user_id") int userId);
    ...
    Call<NoteServiceResponse<ColorRecord>> getNote(@Path("user_id") int userId, @Path("note_id") int noteId);
    ...
    Call<NoteServiceResponse<Integer>> addNote(@Path("user_id") int userId, @Body ColorRecord note);
    ...
    Call<NoteServiceResponse> saveNote(@Path("user_id") int userId, @Path("note_id") int noteId, @Body ColorRecord note);
